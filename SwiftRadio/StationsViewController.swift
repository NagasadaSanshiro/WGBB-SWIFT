        ...
        if segue.identifier == "NowPlaying" {
            ...
            if let indexPath = (sender as? IndexPath) {
                ...
                if searchController.isActive {
                    currentStation = searchedStations[(indexPath as NSIndexPath).row]
                } else {
                    currentStation = stations[(indexPath as NSIndexPath).row]
                }
...
extension StationsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if stations.isEmpty {
            ...
            // The UISeachController is active
            if searchController.isActive {
                let station = searchedStations[(indexPath as NSIndexPath).row]
                cell.configureStationCell(station)
...
extension StationsViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if !stations.isEmpty {
            ...
            let title = stations[(indexPath as NSIndexPath).row].stationName + " - Now Playing..."
            stationNowPlayingButton.setTitle(title, for: UIControlState())
